...
public class ListadoFragment extends Fragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        recyclerView.setAdapter (new  ListadoAdapter (getContext (), memesArrayInfo,memesArray,listener));
    }
}
...
class ListadoAdapter extends RecyclerView.Adapter<ListadoViewHolder> {
    ...
    ListadoAdapter (Context context, ArrayList<String> info, TypedArray imgs, OnMemeTouchedListener listener) {
    ...
    public void onBindViewHolder (@NonNull ListadoViewHolder listadoViewHolder, int i) {
        ...
        listadoViewHolder.itemView.setOnClickListener (view -> {
            if (listener != null) listener.onMemeTouched (i,imgs.getResourceId(i, -1));
        });
    }
